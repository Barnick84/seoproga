...
│       ├── structure.html      # Структура сайта (интерактивное дерево, ИИ генератор, типы страниц, переход к SEO-анализу analysis.html, кластерам cluster.html и live-страницам)
...
| `structure.html` | Визуальный редактор и ИИ-генератор структуры сайта |
| `positions.html` | Мониторинг позиций |
